 ...
 * @line_number: Interger representing the line number of of the opcd.
 */
 ...
 */
void print_topn(stack_t **stack, unsigned int line_number)
{
	if (stack == NULL || *stack == NULL)
		more_ero(6, line_number);
	printf("%d\n", (*stack)->n);
}
